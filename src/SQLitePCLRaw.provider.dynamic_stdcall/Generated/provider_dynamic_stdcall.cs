...
namespace SQLitePCL
{
    ...
    public sealed class SQLite3Provider_dynamic_stdcall : ISQLite3Provider
    {
	...
	static class NativeMethods
	{
		...
		static public void Setup(IGetFunctionPointer gf)
		{
			...
			sqlite3_create_module_v2 = (MyDelegateTypes.sqlite3_create_module_v2) Load(gf, typeof(MyDelegateTypes.sqlite3_create_module_v2));
		}
		...
		public static MyDelegateTypes.sqlite3_create_module_v2 sqlite3_create_module_v2;
	...
	static class MyDelegateTypes
	{
        ...
        [UnmanagedFunctionPointer(CALLING_CONVENTION)]
        public unsafe delegate int sqlite3_create_module_v2(sqlite3 db, byte[] strName, sqlite3_module module, object pClientData)
	}
